...
SubProceso listaPasajeros(bsas_bariloche, bsas_salta, ros_bsas, mardel_mendoza,dimColumnas,dimFila1, dimFila2)
	...
	Segun optionRuta Hacer
		1:
			MuestraPasajerosRuta1(bsas_bariloche,dimColumnas,dimFila1,optionOrdenamiento)
		2:
			MuestraPasajerosRuta2(bsas_salta,dimColumnas,dimFila1,optionOrdenamiento)
		3:
			MuestraPasajerosRuta3(ros_bsas,dimColumnas,dimFila2,optionOrdenamiento)
		4:
			MuestraPasajerosRuta4(mardel_mendoza,dimColumnas,dimFila2,optionOrdenamiento)
...
SubProceso MuestraPasajerosRuta1(bsas_bariloche,dimColumnas,dimFila1,optionOrdenamiento)
	
	si (optionOrdenamiento==1)
		
		para i<-0 hasta dimFila1-1
			escribir Sin Saltar "Nombre y apellido: "
			escribir bsas_bariloche[i,1]
		FinPara
	FinSi
	
	si (optionOrdenamiento==2)
		
		para i<-dimFila1-1 hasta 0 Con Paso -1
			escribir Sin Saltar "Nombre y apellido: "
			escribir bsas_bariloche[i,1]
		FinPara
	FinSi
...
SubProceso MuestraPasajerosRuta2(bsas_salta,dimColumnas,dimFila1,optionOrdenamiento)
	
	si (optionOrdenamiento==1)
		
		para i<-0 hasta dimFila1-1
			escribir Sin Saltar "Nombre y apellido: "
			escribir bsas_salta[i,1]
		FinPara
	FinSi
...
SubProceso MuestraPasajerosRuta3(ros_bsas,dimColumnas,dimFila2,optionOrdenamiento)
	
	si (optionOrdenamiento==1)
		
		para i<-0 hasta dimFila2-1
			escribir Sin Saltar "Nombre y apellido: "
			escribir ros_bsas[i,1]
		FinPara
	FinSi
	
	si (optionOrdenamiento==2)
		
		para i<-dimFila2-1 hasta 0 Con Paso -1
			escribir Sin Saltar "Nombre y apellido: "
			escribir ros_bsas[i,1]
		FinPara
	FinSi
...
SubProceso MuestraPasajerosRuta4(mardel_mendoza,dimColumnas,dimFila2,optionOrdenamiento)
	
	si (optionOrdenamiento==1)
		
		para i<-0 hasta dimFila2-1
			escribir Sin Saltar "Nombre y apellido: "
			escribir mardel_mendoza[i,1]
		FinPara
	FinSi
