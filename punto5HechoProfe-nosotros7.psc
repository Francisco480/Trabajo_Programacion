	...
	si (resultado)
		...
		Segun optionRuta Hacer
			1:
				...
				muestraDatos(contRuta1, bsas_bariloche,dimColumnas,dimFila1,nombreApellido, dni, tel, equipajeBodega, numPasajeroFrec)
			...
			2:
				...
				muestraDatos(contRuta2, bsas_salta,dimColumnas,dimFila1,nombreApellido, dni, tel, equipajeBodega, numPasajeroFrec)
			...
			3:
				...
				muestraDatos(contRuta3, ros_bsas,dimColumnas,dimFila2,nombreApellido, dni, tel, equipajeBodega, numPasajeroFrec)
			...
			4:
				...
				muestraDatos(contRuta4, mardel_mendoza,dimColumnas,dimFila2,nombreApellido, dni, tel, equipajeBodega, numPasajeroFrec)
		...
		para j<-0 hasta dimColumnas-1 hacer
			Segun j Hacer
				...
				4:
					...
					Hasta Que  (equipajeBodega=Mayusculas("Verdadero") o equipajeBodega=Mayusculas("Falso"))
...
//aca es el SubProceso donde muestro los datos por pantalla
SubProceso muestraDatos(contRuta, array ,dimColumnas,dimFila,nombreApellido, dni, tel, equipajeBodega, numPasajeroFrec)
	para i<-0 hasta 0 hacer
		para j<-0 hasta dimColumnas-1 hacer
			Segun j Hacer
				0:
					escribir Sin Saltar "Asiento: "
					escribir array[contRuta,j]
				1:
...
SubProceso buscarPasajero(bsas_bariloche, bsas_salta, ros_bsas, mardel_mendoza,dimColumnas,dimFila1, dimFila2)
	...
	Segun optionRuta Hacer
		1:
			...
			BusquedaPasajeroRuta(bsas_bariloche,dimColumnas,dimFila1, pasajeroABuscar)
		2:
			escribir ("Ingrese el nombre del pasajero a buscar")
			leer pasajeroABuscar
			
			BusquedaPasajeroRuta(bsas_salta,dimColumnas,dimFila1, pasajeroABuscar)
		3:
			escribir ("Ingrese el nombre del pasajero a buscar")
			leer pasajeroABuscar
			BusquedaPasajeroRuta(ros_bsas,dimColumnas,dimFila2,pasajeroABuscar)
		4:
			escribir ("Ingrese el nombre del pasajero a buscar")
			leer pasajeroABuscar
			BusquedaPasajeroRuta(mardel_mendoza,dimColumnas,dimFila2,pasajeroABuscar)
		De Otro Modo:
			Escribir ("Opción ingresada errónea")
...
SubProceso BusquedaPasajeroRuta(array,dimColumnas,dimFila, pasajeroABuscar)
	definir i, banderaAsientoVacio Como Entero
	i=0
	banderaAsientoVacio = 0
	mientras (i<dimFila)
		si array[i,1]==pasajeroABuscar
...
SubProceso listaPasajeros(bsas_bariloche, bsas_salta, ros_bsas, mardel_mendoza,dimColumnas,dimFila1, dimFila2)
	...
	Segun optionRuta Hacer
		1:
			OrdenarPasajeros(bsas_bariloche,dimColumnas,dimFila1,optionOrdenamiento)
			
		2:
			OrdenarPasajeros(bsas_salta,dimColumnas,dimFila1,optionOrdenamiento)
			
		3:
			OrdenarPasajeros(ros_bsas,dimColumnas,dimFila2,optionOrdenamiento)
			
		4:
			OrdenarPasajeros(mardel_mendoza,dimColumnas,dimFila2,optionOrdenamiento)
...
SubProceso OrdenarPasajeros(arreglo,dimColumnas,dimFila,optionOrdenamiento)
	definir arrayNombres Como Caracter
	dimension arrayNombres[dimFila]
	para i<-0 hasta dimFila-1
			arrayNombres[i]=arreglo[i,1]
	FinPara
	definir array como entero
	Dimension array[dimFila]
	para i<-0 hasta dimFila-1
		si arreglo[i,0]<>"" Entonces
			array[i]=ConvertirANumero(arreglo[i,0])
		SiNo
			array[i]=i+1
		FinSi
		
	FinPara
	definir numPasaje, j, pos_menor, aux Como Entero
	definir cant_comparaciones Como Entero
	cant_comparaciones = 0
	si (optionOrdenamiento==1)
		para i<-0 hasta dimFila-2 Hacer
			pos_menor<-i
			para j<-i+1 hasta dimFila-1 Hacer
				si array[j]<array[pos_menor] Entonces
					pos_menor<-j
				FinSi
	...
	para i<-0 hasta dimFila-1
			escribir Sin Saltar "Nombre y apellido: "
			escribir arrayNombres[(array[i])-1]
	FinPara
	FinSi
